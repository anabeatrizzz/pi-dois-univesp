import { Grid, Typography, Card, CardContent, useMediaQuery, useTheme } from '@mui/material';
      ...
      <div style={styles.grid}>
        <Grid style={styles.containerWrapper} container>
          <Grid style={styles.container} container>
            <Typography
              style={matches ? { ...styles.title, fontSize: 20 } : styles.title}
              align="center"
            >
              SOBRE A PAMNET
            </Typography>
            <div style={styles.subtitleDiv}>
              <Typography
                style={matches ? { ...styles.subtitle, fontSize: 20 } : styles.subtitle}
                align="center"
              >
        ...
        <Grid container>
          ...
          <Grid item xs={matches ? 12 : 6}>
            <Typography
              align="center"
              style={matches ? { ...styles.cardTitle, marginTop: 20 } : styles.cardTitle}
            >
